#Extrating information from the website using beautiful soup and parsing the HTML and XML code of web pages
...
#Assignment
#extract all bird species from https://xeno-canto.org/ and generate 
# the csv file or JSON file for the bird species, family and more
#extract all bird songs from https://xeno-canto.org/
#use this API to get data. the endpoint for the web service is https://xeno-canto.org/api/2/recordings

#Answers
#1. extract all bird species 
from bs4 import BeautifulSoup
import requests
import json
